...
I have developed cstag, a Python library and cstag-cli, a command-line tool to further use the expression of the CS tag. The cstag is a toolkit for performing various operations and visualizations on CS tags, while cstag-cli is a tool for adding CS tags to existing SAM/BAM files.
...
![Visualization of CS tags by VCF and HTML outputs.](figure1.png)
